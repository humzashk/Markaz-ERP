...
router.get('/', wrap(async (req, res) => {
  ...
  res.render('daybook/index', { page:'daybook', date, invoices, purchases, payments, paymentsIn, paymentsOut, expenses, totalSales, totalPurchases, totalIn, totalOut, totalExpenses });
}));
